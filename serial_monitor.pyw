# 300000044099099@0602203600833"600841"454881"
# // BINES PUP1.8.7
# 1002333030303030303337303939303939403036303135303236303038333322363030383431221003
# //BINES CON TARJETA CLS
# 100233303030303030343430393930393940303630323230333630303833332236303038343122343930373237221003
# //BORRAR
# 10023330303030303032343039393039394030363030303230301003
# //BINES CON TARJETA BANDA
# 100233303030303030343430393930393940303630323230333630303833332236303038343122343534383831221003
...
def append_crc(text):
	...
	crc = '%04X' % calc_crc(textCRC)
	return text.__add__(crc)
...
def sendOPEMVDCCCmd(event):
	global DccScreen
	sendMSGCmd(MSG1001)
	DccScreen = True

def sendOPEMVSinCifradoCmd(event):
	sendMSGCmd(MSG1000)

def sendOPPrivadaCmd(event):
	sendMSGCmd(MSG1003)

def sendMSGCmd(MSG):
	global rx
	rx = ''
	tx_msg = bytes.fromhex(MSG)[2:6]
	msg = bytes.decode(tx_msg,'utf-8')
	txt = append_crc(MSG)
	print(">> MSG TX:",msg,bytes.fromhex(txt))
	bs = bytes.fromhex(txt)
	if lineEndingCbo.current() == 1:
		bs += b'\n'
	elif lineEndingCbo.current() == 2:
...
def checkReceiveMSG():
	...
	print("<< MSG RX:",msg, bytes.fromhex(rx))
	match msg:
		case "0300":
			sendMSGCmd(MSG0310)
			sendMSGCmd(MSG1000)
...
def disableSending():
	...
	txText.unbind('<Return>')
	OPEMVDCCBtn['state'] = tk.DISABLED
	txText.unbind('<Return>')
	OPEMVSinCifradoBtn['state'] = tk.DISABLED
	txText.unbind('<Return>')
	OPPrivadaBtn['state'] = tk.DISABLED
	txText.unbind('<Return>')
...
def enableSending():
	...
	OPEMVDCCBtn['state'] = tk.NORMAL
	txText.bind('<Return>', sendOPEMVDCCCmd)
	OPEMVSinCifradoBtn['state'] = tk.NORMAL
	txText.bind('<Return>', sendOPEMVSinCifradoCmd)
	OPPrivadaBtn['state'] = tk.NORMAL
	txText.bind('<Return>', sendOPPrivadaCmd)
...
if __name__ == '__main__':
	...
	OPEMVSinCifradoBtn = tk.Button(root, width=12, text='OP EMV SN/CIF', state=tk.DISABLED, command=lambda:sendOPEMVSinCifradoCmd(None))
	OPEMVSinCifradoBtn.grid(row=1, column=3, padx=4, pady=4, sticky=tk.NE)
	OPEMVDCCBtn = tk.Button(root, width=12, text='OP EMV DCC', state=tk.DISABLED, command=lambda:sendOPEMVDCCCmd(None))
	OPEMVDCCBtn.grid(row=1, column=4, padx=4, pady=4, sticky=tk.NE)
	OPPrivadaBtn = tk.Button(root, width=12, text='OP PRIVADA', state=tk.DISABLED, command=lambda:sendOPPrivadaCmd(None))
	OPPrivadaBtn.grid(row=1, column=5, padx=4, pady=4, sticky=tk.NE)
